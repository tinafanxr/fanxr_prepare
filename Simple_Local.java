...
//		 Thread.sleep(3000);	
//		 	
		WebElement re1 = dr.findElement(By.partialLinkText("re"));
		//((JavascriptExecutor)dr).executeScript("$(arguments[0]).fadeOut().fadeIn()",re1);
		
		System.out.println("执行js register1");
		Thread.sleep(3000);	
